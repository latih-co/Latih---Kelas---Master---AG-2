                          ...
                          <div style={{ marginTop: 12, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                            <button
                              ...
                              onClick={async () => {
                                ...
                                await approveNameChange(req.id, req.user_id, req.new_name, req.profiles?.email, req.old_name, req.profiles?.name);
                                setNameActioning('');
                                await loadAll();
                              }}
                          ...
                          <div style={{ marginTop: 12, padding: '12px', background: '#FFF1F2', border: '1px solid #FECDD3', borderRadius: 10 }}>
                            ...
                            <div style={{ display: 'flex', gap: 8 }}>
                              <button
                                ...
                                onClick={async () => {
                                  setNameActioning(req.id);
                                  await rejectNameChange(req.id, rejectNote, req.profiles?.email, req.old_name, req.new_name, req.profiles?.name);
                                  setNameActioning('');
